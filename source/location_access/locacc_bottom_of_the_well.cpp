...
void AreaTable_Init_BottomOfTheWell() {
    ...
    if (Dungeon::BottomOfTheWell.IsVanilla()) {
        areaTable[BOTTOM_OF_THE_WELL_MAIN_AREA] =
            Area("Bottom of the Well Main Area", "Bottom of the Well", BOTTOM_OF_THE_WELL, NO_DAY_NIGHT_CYCLE,
                 {
                     // Events
                     EventAccess(&StickPot, { [] { return true; } }),
                     EventAccess(&BotWLowerWater,
                                 { [] { return BotWLowerWater || CanPlay(ZeldasLullaby); },
                                   /*Glitched*/
                                   [] {
                 ...
                 },
                 {
                     ...
                     Entrance(BOTTOM_OF_THE_WELL_COFFIN_ROOM,
                              { [] { return IsChild || CanDive || IronBoots || Hookshot; } }),
                     Entrance(BOTTOM_OF_THE_WELL_FIRE_KEESE_ROOM, { [] {
                                  return SmallKeys(BOTTOM_OF_THE_WELL, 3) && (LogicLensBotw || CanUse(LENS_OF_TRUTH));
                              } }),
                     Entrance(BOTTOM_OF_THE_WELL_BOSS_ROOM,
                              { [] { return BotWLowerWater; },
                                /*Glitched*/
                     ...
                     Entrance(BOTTOM_OF_THE_WELL_LIKE_LIKE_CAGE,
                              { [] { return false; },
                                /*Glitched*/
                                [] { return CanDoGlitch(GlitchType::HookshotClip, GlitchDifficulty::NOVICE); } }),
                 });

        areaTable[BOTTOM_OF_THE_WELL_BASEMENT] =
            Area("Bottom of the Well Basement", "Bottom of the Well", BOTTOM_OF_THE_WELL, NO_DAY_NIGHT_CYCLE,
                 {
                     // Events
                     EventAccess(&StickPot, { [] { return true; } }),
                 ...
                 },
                 {
                     ...
                     LocationAccess(BOTTOM_OF_THE_WELL_MAP_CHEST,
                                    { [] {
                                         return CanBlastOrSmash || Here(BOTTOM_OF_THE_WELL_BASEMENT_BOMB_FLOWERS,
                                                                        [] { return GoronBracelet; });
                                     },
                                      /*Glitched*/
                                      [] {
                                          return (CanUse(STICKS) &&
                                                  CanDoGlitch(GlitchType::QPA, GlitchDifficulty::NOVICE)) ||
                                                 (CanUse(LONGSHOT) && CanDoGlitch(GlitchType::HookshotClip,
                                                                                  GlitchDifficulty::INTERMEDIATE));
                                      } }),
                 },
                 {
                     ...
                     Entrance(BOTTOM_OF_THE_WELL_BASEMENT_BOMB_FLOWERS, { [] {
                                  return CanBlastOrSmash || CanUse(DINS_FIRE) ||
                                         Here(BOTTOM_OF_THE_WELL_BASEMENT_BOMB_FLOWERS,
                                              [] { return CanUse(BOW) || GoronBracelet; });
                              } }),
                 });

        areaTable[BOTTOM_OF_THE_WELL_BASEMENT_BOMB_FLOWERS] =
            Area("Bottom of the Well Basement Bomb Flowers", "Bottom of the Well", BOTTOM_OF_THE_WELL,
                 NO_DAY_NIGHT_CYCLE, {}, {},
                 {
                     // Exits
                     Entrance(BOTTOM_OF_THE_WELL_BASEMENT,
                              { [] { return CanBlastOrSmash || CanUse(BOW) || GoronBracelet || CanUse(DINS_FIRE); } }),
                 });

        areaTable[BOTTOM_OF_THE_WELL_COFFIN_ROOM] =
            Area("Bottom of the Well Coffin Room", "Bottom of the Well", BOTTOM_OF_THE_WELL, NO_DAY_NIGHT_CYCLE, {},
                 {
                     // Locations
                     LocationAccess(BOTTOM_OF_THE_WELL_FREESTANDING_KEY,
                                    { [] { return HasFireSourceWithTorch || CanUse(BOOMERANG); } }),
                 },
                 {
                     // Exits
                     Entrance(BOTTOM_OF_THE_WELL_MAIN_AREA, { [] { return true; } }),
        ...
        areaTable[BOTTOM_OF_THE_WELL_BOSS_ROOM] =
            Area("Bottom of the Well Boss Room", "Bottom of the Well", BOTTOM_OF_THE_WELL, NO_DAY_NIGHT_CYCLE, {},
                 {
                     // Locations
                     LocationAccess(BOTTOM_OF_THE_WELL_LENS_OF_TRUTH_CHEST, { [] {
                                        return CanUse(KOKIRI_SWORD) || CanUse(MASTER_SWORD) || CanUse(BIGGORON_SWORD) ||
                                               (CanUse(STICKS) && LogicChildDeadhand);
                                    } }),
        ...
        areaTable[BOTTOM_OF_THE_WELL_EAST_INNER_ROOM] =
            Area("Bottom of the Well East Inner Room", "Bottom of the Well", BOTTOM_OF_THE_WELL, NO_DAY_NIGHT_CYCLE, {},
                 {
                     // Locations
        ...
        areaTable[BOTTOM_OF_THE_WELL_WEST_INNER_ROOM] =
            Area("Bottom of the Well West Inner Room", "Bottom of the Well", BOTTOM_OF_THE_WELL, NO_DAY_NIGHT_CYCLE,
                 {
                     // Events
        ...
        areaTable[BOTTOM_OF_THE_WELL_LIKE_LIKE_CAGE] =
            Area("Bottom of the Well Like Like Cage", "Bottom of the Well", BOTTOM_OF_THE_WELL, NO_DAY_NIGHT_CYCLE, {},
                 {
                     // Locations
